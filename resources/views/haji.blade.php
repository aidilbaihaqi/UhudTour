      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('index-haji') }}">Paket Haji</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-lg-12 mt-2">
            <div class="d-flex justify-content-around">
              <img src="./img/HAJJ BANNER ok.png" width="49%" alt="">
              <img src="./img/PAKET HAJI FURODA.png" width="49%" alt="">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12 mt-5">
            <h5>Daftar Paket Haji</h5>
                  ...
                  <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          <a href="{{ route('show-haji', $d->id) }}" class="btn btn-sm btn-outline-primary">View</a>
                        </div>
                        <small class="text-muted">Paket Haji Terbaru</small>
                      </div>
                    </div>
                  </div>
                </div>
