                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <div class="d-flex justify-content-between">
                                        <h6 style="color: #108DE9;" class="m-0 font-weight-bold">Paket Haji</h6>
                                        <a href="{{ route('haji.create') }}" class="btn btn-sm text-white" style="background-color: #108DE9;">Tambah Paket</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $d->tahun_keberangkatan }}</td>
                                                    <td>{{ $d->kamar }}</td>
                                                    <td>{{ $d->harga }}</td>
                                                    <td>
                                                        <form action="{{ route('haji.destroy', $d->id) }}" method="post">
                                                            <a href="{{ route('haji.edit', $d->id) }}" class="btn btn-md btn-primary">
