...
<head>
  ...
  <title>Checkout Paket Haji</title>
  <!-- Bootstrap CDN -->
    ...
    <main>
      ...
      <div class="row g-5">
        <div class="col-md-5 col-lg-4 order-md-last">
          ...
          <div class="col">
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                <p class="card-text">15 JULI 2023 | BRONZE</p>
                <p class="card-text"><i class="fa-solid fa-calendar-days"></i> 15 Juli 2023</p>
                <p class="card-text text-danger">IDR 30.000.000</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-7 col-lg-8">
          ...
          <form action="{{ route('store-haji', $data->id) }}" method="POST">
            @csrf
            <div class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12">
                <label for="arafah" class="form-label">Arafah</label>
                <input type="text" class="form-control" name="arafah" id="arafah" value="{{ $data->arafah }}" disabled>
              </div><div class="col-12">
                <label for="aziziyah" class="form-label">Aziziyah</label>
                <input type="text" class="form-control" name="aziziyah" id="aziziyah" value="{{ $data->aziziyah }}" disabled>
              </div><div class="col-12">
                <label for="mabit" class="form-label">Mabit</label>
                <input type="text" class="form-control" name="mabit" id="mabit" value="{{ $data->mabit }}" disabled>
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                <label for="tahun_keberangkatan" class="form-label">Tahun Keberangkatan</label>
                <input type="text" class="form-control" name="tahun_keberangkatan" id="tahun_keberangkatan" value="{{ $data->tahun_keberangkatan }}" disabled>
              </div>
              <div class="col-12">
            ...
            <div class="row gy-3">
              <div class="col-12 d-none">
                <input type="number" class="form-control" name="haji_id" id="haji_id" value="{{ $data->id }}" required>
              </div>
              <div class="col-12">
            ...
            <a href="{{ route('index-haji') }}" class="w-25 btn btn-secondary btn-md">Kembali</a>
          </form>
        </div>
      </div>
    </main>
